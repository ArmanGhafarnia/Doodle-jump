...
CODE segment para 'CODE'
	...
	POP AX         
        ...
        check_time:
		    ...
		    cmp game_active, 00h
			je  show_game_over    ;show game over
			
			
            mov ah,2ch
            int 21h
            cmp dl, time
            je check_time       ;check if time changed  0.01 sec
            mov time, dl
			
			call Clear_screen   ;clear ball footprint
	...
	not_pressed:
				...
				go_to_up:
				   ...
				   cmp Ball_y, AX
				   Jl neg_velocity_y1     ;check for uppest or no
				   jmp a
				 
				   neg_velocity_y1:
				    neg Ball_velocity_y
					MOV downside,01h       ; come back down
					MOV upside, 00h
					RET	
				   ...
				   a:	
			         ...
			         add Ball_y, AX	             ;add to accelerate befor reach uppest
					 jmp b
	...
	Clear_screen proc NEAR
			...
			mov ah, 0bh   ;
            mov bh, 00h   ;  
			mov bl, 00h   ;    clear the screen BLACK
			int 10h       ;
